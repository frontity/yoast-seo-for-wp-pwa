...
add_filter('rest_prepare_latest', 'get_site_info');
...
function get_site_info($data) {
  $data['yoast_meta'] = array(
    yoast_wpseo_title => get_title_home_wpseo(),
    yoast_wpseo_metadesc => get_metadesc_home_wpseo()
  );
  return $data;
 }
